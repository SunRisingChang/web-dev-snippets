module.exports = {
  ...
  rp: {
    ...
    body: "<rp>$1</rp>$2",
    description:
      "HTML - Used in ruby annotations to define what to show browsers that do not support the ruby element"
  },
  rt: {
    prefix: "rt",
    body: "<rt>$1</rt>$2",
  ...
  summary: {
    ...
    description:
      "HTML - Defines a visible heading for the detail element [limited support]"
  },
  table: {
    prefix: "table",
    body: ["<table>", "\t$1", "</table>"],
