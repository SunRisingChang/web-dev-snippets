module.exports = {
  ...
  "typedarray.copyWithin(target, start[, end = this.length])": {
    "prefix": "bigcopywithin",
    "body": [
      "${1:biguint64array}.copyWithin(${2})"
    ],
  ...
  "typedarray.reduceRight(callback[, initialValue])": {
    "prefix": "bigreduceright",
    "body": [
      "${1:biguint64array}.reduceRight(${2})"
    ],
  ...
  "typedarray.toLocaleString([locales [, options]]);": {
    ...
    "body": [
      "${1:biguint64array}.toLocaleString(${2})"
    ],
