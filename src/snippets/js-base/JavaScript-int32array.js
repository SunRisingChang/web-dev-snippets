module.exports = {
  ...
  "typedarray.copyWithin(target, start[, end = this.length])": {
    "prefix": "intcopywithin",
    "body": [
      "${1:int32array}.copyWithin(${2})"
    ],
  ...
  "typedarray.lastIndexOf(searchElement[, fromIndex = typedarray.length])": {
    "prefix": "intlastindexof",
    "body": [
      "${1:int32array}.lastIndexOf(${2})"
    ],
  ...
  "typedarray.reduceRight(callback[, initialValue])": {
    "prefix": "intreduceright",
    "body": [
      "${1:int32array}.reduceRight(${2})"
    ],
  ...
  "typedarray.toLocaleString([locales [, options]]);": {
    "prefix": "inttolocalestring",
    "body": [
      "${1:int32array}.toLocaleString(${2})"
    ],
